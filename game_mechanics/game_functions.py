...
# FUNCTIONS TO RESPOND TO KEYBOARD AND MOUSE PRESSES.
...
# FUNCTION TO DRAW THE NEW POSITION OF EACH OBJECT TO THE SCREEN.
def update_screen(ai_settings, screen, stats, sb, ship, aliens, bullets,
        play_button):
    """Update images on the screen and flip to the new screen."""
    # Redraw the screen during each pass through the loop.
    screen.fill(ai_settings.bg_color) # Fill background with given color.
    # Redraw all bullets behind ship and aliens.
    for bullet in bullets.sprites():
        bullet.draw_bullet()
    ship.blitme()
    #alien.blitme()
    aliens.draw(screen) # Draw each alien of t g on t scr.
...
# FUNCTIONS TO UPDATE THE POSITION OF BULLETS AND ALIEN SINCE BECAUSE
# THEIR MOVEMENT IS INDEPENDEND OF THE PLAYER'S KEY AND MOUSE PRESSES.
...
# FUNCTIONS TO CREATE AN ALIEN AND ALIEN FLEET.
...
# FUNCTIONS TO CHANGE DIRECTION OF THE ALIEN FLEET.
...
# FUNCTION TO REDUCE LIVES OF PLAYER.
